<div class="col-md-12 col-lg-12">
    <div class="card mg-b-20">
        ...
        <div class="card-body collapse show" id="collapse7">
            <form class="needs-validation" action="index.php?action=Pago/AddInscripcion" method="post" novalidate>
                <div class="form-row">
                        ...
                        <div class="input-group mb-6">
                            <select class="selectpicker form-control" data-hide-disabled="true" data-live-search="true" name="idcliente" id="idcliente" id="inputGroupSelect01" required>
                                ...
                                foreach ($persona as $key => $persona) :
                                    ...
                                    if ($precio->nombre != "DIARIO" && $cliente->inscripcion==null) {
                                ...
                                ?>
                                            <option value="<?php echo $cliente->id; ?>"><?php echo $cliente->nombre ." ".$cliente->apellido." -> ".$cliente->telefono; ?></option>
